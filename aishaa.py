...
def menu3():
    try:
        ...
        k3 = ('token.txt')
        key1=open(f'/data/data/com.termux/files/usr/bin/{xx}','r').read()
        key=(f'AYUSH-YWR-APRUAL-DO{uid}5X{key1}110E==')#full key
        mysite= requests.get("https://github.com/aishakumari/multi/tree/main").text#approve site
        if key in mysite:
                print(logo)
...
\__|  \__|\______| \______/ \__|  \__|\__|  \__|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       
\x1b[1;30m════════════════════════════════════════════════════════
\033[1;31m▇==➤ ADMIN : D3VIIL GIRL ISHU 
\033[1;37m▇==➤ GITHUB : AISHAKUMARI
\033[1;31m▇==➤ CREATOR : D3V1L GIIRL ISHU
\033[1;37m▇==➤ FACEBOOK : AIISHA PIIE
\x1b[1;30m════════════════════════════════════════════════════════
\033[1;33m[•] 01  START TOOL ADD FB ID\033[1;36m
\033[1;32m[•] 02  START TOOL TOKAN CONVO\033[1;36m
\033[1;30m[•] 00  EXIT TOOL \033[1;36m
════════════════════════════════════════════════════════""")
                os.system('espeak -a 300 "OPTION CHUNE                     ONE                     YA                     TWO                     YA                     ZERO"')
                key = input("[+] Choose : ")                
                if key in [""]:
                    print("(×) Please Select Correct Option")
                    logo()
                elif key in ["1","01"]:
                    os.system("am start https://www.facebook.com/shahanawaj.khan.1829"+key)                
                ...
                os.system('espeak -a 300 "well,come to, AISHA, tools"')
                print(f'[•] Your Key : '+key)
                os.system("am start https://wa.me/+919905389665?text="+key)
                input(f'[] Press Enter For Approve ')    
                whatsapp = "+919905389665"
                url_wa = "https://api.whatsapp.com/send?phone="+whatsapp+"&text="
                tks = ("Hello AISHA PIIE, I Need To Buy Your Paid Tools Please Approve My Key :)\n\n Key :- "+key)
                subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                
                print(f'run :  python aishaa.py');pass
    except ValueError:
        print('');pass
...
testPY()
print('''\033[1;32m.═════════RUL3X═>CHOD══════D3VIIL-GIIRL-ISHU════════════════════════════════════════\n''')
def venom():
    clear = "\x1b[0m"
    colors = [35, 33, 36]
    ...
    y = '''
\033[1;33m════════════════════════════════════════════════════════
\033[1;31m N4ME    \033[1;34m: \033[1;33mAIISHA PIIE
\033[1;36m CrEaToR  \033[1;35m: \033[1;34mD3VIIL GIIRL ISHU             
\033[1;31m OWN3R   \033[1;36m: \033[1;35mD3VIIL GIRL ISHU
\033[1;36m Contact \033[1;33m: \033[1;36m+919905389665
\033[1;33m════════════════════════════════════════════════════════
    ...
    for i in ns:
        try:
            ...
            if s.ok:
                ...
                print (e.strftime("--> D3VIIL G1RL ISHU :D | | Date :: %d-%m-%Y  TIME :: %I:%M:%S %p"))
                print("--> Message Successfully Sent By TH3 L3G3ND GIIRL AISHA♻️ :D ::-->> ", message, "\n")
                print('''\033[1;33m════════════════════════════════════════════════════════\n''')
                time.sleep(timm)
            else:
...
if int:    
    ...
    print('''\033[1;32m[•] _ Tool Creator == > [ TH3 UNBEATABLE GIRL ISHU♻️ ]\n''')
    print("\033[1;36;40m", end = "")
    print(f"""\x1b[1;97m 
    

\033[1;36m  $$$$$$\  $$$$$$\  $$$$$$\  $$\   $$\  $$$$$$\  
\033[1;36m $$  __$$\ \_$$  _|$$  __$$\ $$ |  $$ |$$  __$$\ 
\033[1;36m $$ /  $$ |  $$ |  $$ /  \__|$$ |  $$ |$$ /  $$ |
\033[1;36m $$$$$$$$ |  $$ |  \$$$$$$\  $$$$$$$$ |$$$$$$$$ |
\033[1;36m $$  __$$ |  $$ |   \____$$\ $$  __$$ |$$  __$$ |
\033[1;36m $$ |  $$ |  $$ |  $$\   $$ |$$ |  $$ |$$ |  $$ |
\033[1;36m $$ |  $$ |$$$$$$\ \$$$$$$  |$$ |  $$ |$$ |  $$ |
\033[1;36m \__|  \__|\______| \______/ \__|  \__|\__|  \__|                                                                                                                                                                                                                                                                                                                                                           
\x1b[1;34m════════════════════════════════════════════════════════
\033[1;31m▇==➤ ADMIN       : D3VIL GIRL ISHU H3R3
\033[1;32m▇==➤ GITHUB       : AISHAKUMARI
\033[1;30m▇==➤ OWNER       : ISHU
\033[1;32m▇==➤ FACEBOOK   : AIISHA PIIE
\033[1;37m════════════════════════════════════════════════════════""")
    os.system('espeak -a 300 "3NJOY KRO"')
